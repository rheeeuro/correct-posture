...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! axios */ \"../node_modules/axios/index.js\");\n/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(axios__WEBPACK_IMPORTED_MODULE_0__);\nfunction asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }\n\nfunction _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"next\", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"throw\", err); } _next(undefined); }); }; }\n\n\nvar btnContainer = document.getElementById(\"jsBtnContainer\");\nvar judgeAnchor = document.getElementById(\"jsJudgeAnchor\");\nvar judgeBtn = document.getElementById(\"jsJudgeBtn\");\nvar inputTotal = document.getElementById(\"goodTotal\");\nvar inputHead = document.getElementById(\"goodHead\");\nvar inputShoulder = document.getElementById(\"goodShoulder\");\nvar inputLeg = document.getElementById(\"goodLeg\");\nvar totalBar = document.getElementById(\"jsTotalBar\");\nvar headBar = document.getElementById(\"jsHeadBar\");\nvar shoulderBar = document.getElementById(\"jsShoulderBar\");\nvar legBar = document.getElementById(\"jsLegBar\");\nvar id = document.getElementById(\"userId\");\nvar intervalId;\nvar count = {\n  goodTotal: 0,\n  badTotal: 0,\n  goodHead: 0,\n  badHead: 0,\n  goodShoulder: 0,\n  badShoulder: 0,\n  goodLeg: 0,\n  badLeg: 0,\n  percentTotal: 0,\n  percentHead: 0,\n  percentShoulder: 0,\n  percentLeg: 0\n};\n\nvar saveStatistics = /*#__PURE__*/function () {\n  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {\n    var response;\n    return regeneratorRuntime.wrap(function _callee$(_context) {\n      while (1) {\n        switch (_context.prev = _context.next) {\n          case 0:\n            _context.next = 2;\n            return axios__WEBPACK_IMPORTED_MODULE_0___default()({\n              url: \"/api/save-statistics\",\n              method: \"POST\",\n              data: {\n                goodTotal: count.goodTotal,\n                badTotal: count.badTotal,\n                goodHead: count.goodHead,\n                badHead: count.badHead,\n                goodShoulder: count.goodShoulder,\n                badShoulder: count.badShoulder,\n                goodLeg: count.goodLeg,\n                badLeg: count.badLeg\n              }\n            });\n\n          case 2:\n            response = _context.sent;\n\n            if (response.status === 200) {\n              console.log(\"save success!\");\n            }\n\n          case 4:\n          case \"end\":\n            return _context.stop();\n        }\n      }\n    }, _callee);\n  }));\n\n  return function saveStatistics() {\n    return _ref.apply(this, arguments);\n  };\n}();\n\nvar countFunction = function countFunction() {\n  if (inputTotal.value === \"true\") {\n    count.goodTotal += 1;\n  } else {\n    count.badTotal += 1;\n  }\n\n  if (inputHead.value === \"true\") {\n    count.goodHead += 1;\n  } else {\n    count.badHead += 1;\n  }\n\n  if (inputShoulder.value === \"true\") {\n    count.goodShoulder += 1;\n  } else {\n    count.badShoulder += 1;\n  }\n\n  if (inputLeg.value === \"true\") {\n    count.goodLeg += 1;\n  } else if (inputLeg.value === \"false\") {\n    count.badLeg += 1;\n  }\n\n  count.percentTotal = Math.round(100 * (count.goodTotal / (count.goodTotal + count.badTotal)));\n  count.percentHead = Math.round(100 * (count.goodHead / (count.goodHead + count.badHead)));\n  count.percentShoulder = Math.round(100 * (count.goodShoulder / (count.goodShoulder + count.badShoulder)));\n  count.percentLeg = Math.round(100 * (count.goodLeg / (count.goodLeg + count.badLeg)));\n  totalBar.style.width = \"\".concat(count.percentTotal, \"%\");\n  headBar.style.width = \"\".concat(count.percentHead, \"%\");\n  shoulderBar.style.width = \"\".concat(count.percentShoulder, \"%\");\n  legBar.style.width = \"\".concat(count.percentLeg, \"%\");\n\n  if (count.percentTotal >= 5) {\n    totalBar.innerHTML = \"\".concat(count.percentTotal, \"%\");\n  } else {\n    totalBar.innerHTML = \"\";\n  }\n\n  if (count.percentHead >= 5) {\n    headBar.innerHTML = \"\".concat(count.percentHead, \"%\");\n  } else {\n    headBar.innerHTML = \"\";\n  }\n\n  if (count.percentShoulder >= 5) {\n    shoulderBar.innerHTML = \"\".concat(count.percentShoulder, \"%\");\n  } else {\n    shoulderBar.innerHTML = \"\";\n  }\n\n  if (count.percentLeg >= 5) {\n    legBar.innerHTML = \"\".concat(count.percentLeg, \"%\");\n  } else {\n    legBar.innerHTML = \"\";\n  }\n};\n\nvar handleSave = function handleSave() {\n  clearInterval(intervalId);\n\n  if (id) {\n    saveStatistics();\n  } // recommend type\n\n\n  var recommend = 0;\n\n  if (count.goodLeg !== 0 || count.badLeg !== 0) {\n    if (count.percentHead < count.percentShoulder && count.percentHead < count.percentLeg && count.percentHead < 70) {\n      recommend = 1;\n    } else if (count.percentShoulder < count.percentHead && count.percentShoulder < count.percentLeg && count.percentShoulder < 70) {\n      recommend = 2;\n    } else if (count.percentLeg < count.percentHead && count.percentLeg < count.percentShoulder && count.percentLeg < 70) {\n      recommend = 3;\n    }\n  } else if (count.percentHead < count.percentShoulder && count.percentHead < 70) {\n    recommend = 1;\n  } else if (count.percentShoulder < count.percentHead && count.percentShoulder < 70) {\n    recommend = 2;\n  } // reset\n\n\n  count.goodTotal = 0;\n  count.badTotal = 0;\n  count.goodHead = 0;\n  count.badHead = 0;\n  count.goodShoulder = 0;\n  count.badShoulder = 0;\n  count.goodLeg = 0;\n  count.badLeg = 0; // change event listener\n\n  judgeAnchor.removeEventListener(\"click\", handleSave);\n  judgeAnchor.href = \"/posture/recommend/\".concat(recommend);\n  judgeAnchor.click();\n};\n\nvar handleStart = function handleStart() {\n  // notice start\n  intervalId = setInterval(countFunction, 1000); // change view\n\n  judgeBtn.innerHTML = \"Save Judge!\";\n  totalBar.innerHTML = \"\";\n  headBar.innerHTML = \"\";\n  shoulderBar.innerHTML = \"\";\n  legBar.innerHTML = \"\"; // change event listener\n\n  judgeAnchor.removeEventListener(\"click\", handleStart);\n  judgeAnchor.addEventListener(\"click\", handleSave);\n};\n\nfunction init() {\n  judgeAnchor.addEventListener(\"click\", handleStart);\n}\n\nif (btnContainer) {\n  init();\n}\n\n//# sourceURL=webpack:///./assets/js/judge.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _scss_styles_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../scss/styles.scss */ \"./assets/scss/styles.scss\");\n/* harmony import */ var _scss_styles_scss__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_scss_styles_scss__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _judge__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./judge */ \"./assets/js/judge.js\");\n/* harmony import */ var _saveHistory__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./saveHistory */ \"./assets/js/saveHistory.js\");\n\n\n\n\n//# sourceURL=webpack:///./assets/js/main.js?");

/***/ }),

/***/ "./assets/js/saveHistory.js":
/*!**********************************!*\
  !*** ./assets/js/saveHistory.js ***!
  \**********************************/
/*! no exports provided */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! axios */ \"../node_modules/axios/index.js\");\n/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(axios__WEBPACK_IMPORTED_MODULE_0__);\nfunction asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }\n\nfunction _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"next\", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"throw\", err); } _next(undefined); }); }; }\n\n\nvar exerciseContainer = document.getElementById(\"jsExerciseContainer\");\nvar saveButton = document.getElementById(\"saveButton\");\nvar redirectButton = document.getElementById(\"redirectButton\");\nvar setCount = document.getElementById(\"setCount\");\n\nvar handleRedirect = function handleRedirect() {\n  location.reload();\n};\n\nvar addHistory = /*#__PURE__*/function () {\n  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(id, set) {\n    var response;\n    return regeneratorRuntime.wrap(function _callee$(_context) {\n      while (1) {\n        switch (_context.prev = _context.next) {\n          case 0:\n            _context.next = 2;\n            return axios__WEBPACK_IMPORTED_MODULE_0___default()({\n              url: \"/api/\".concat(id, \"/save-history\"),\n              method: \"POST\",\n              data: {\n                set: set\n              }\n            });\n\n          case 2:\n            response = _context.sent;\n\n            if (response.status === 200) {\n              console.log(\"save success!\");\n            }\n\n          case 4:\n          case \"end\":\n            return _context.stop();\n        }\n      }\n    }, _callee);\n  }));\n\n  return function addHistory(_x, _x2) {\n    return _ref.apply(this, arguments);\n  };\n}();\n\nvar handleSave = function handleSave() {\n  var exerciseId = window.location.href.split(\"/posture/\")[1];\n  var set = parseInt(setCount.innerHTML.split(\": \")[1], 10);\n\n  if (set > 0) {\n    addHistory(exerciseId, set);\n  }\n\n  setTimeout(handleRedirect, 2000);\n};\n\nif (exerciseContainer) {\n  redirectButton.addEventListener(\"click\", handleRedirect);\n  saveButton.addEventListener(\"click\", handleSave);\n}\n\n//# sourceURL=webpack:///./assets/js/saveHistory.js?");
...
eval("__webpack_require__(/*! @babel/polyfill */\"../node_modules/@babel/polyfill/lib/index.js\");\nmodule.exports = __webpack_require__(/*! D:\\web\\c-posture\\src\\assets\\js\\main.js */\"./assets/js/main.js\");\n\n\n//# sourceURL=webpack:///multi_@babel/polyfill_./assets/js/main.js?");
